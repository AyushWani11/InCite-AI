					...
					<div className='space-y-8'>
						<div className='space-y-6'>
							<h1 className='text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight'>
								Transform Your <br />
								Research with <span className='text-teal-500'>
									AI-Powered
								</span>{' '}
								Paper Management
							</h1>
							...
							<div className='p-6 space-y-6'>
								...
								<div className='bg-teal-50 rounded-lg p-4 border border-teal-200'>
									...
									<div className='text-sm text-teal-700'>
										This paper introduces a novel approach to natural language
										processing using transformer architectures with
										self-attention mechanisms. The authors demonstrate a 12%
										improvement over previous state-of-the-art methods on
										standard benchmarks.
									</div>
								</div>
