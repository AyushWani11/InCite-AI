	...
	const steps = [
		{
			...
			description:
				'Simply drag and drop your research papers in PDF, DOC, or text format. Our AI will process and analyze them instantly.',
			details: [
		...
		},
		{
			...
			title: 'AI Processing',
			description:
				'Our Gemini AI analyzes your papers, extracting key information, generating summaries, and preparing for interactive chat.',
			details: [
		...
		},
		{
			...
			description:
				'Ask questions, get summaries, search semantically, and assess quality - all through our intuitive interface.',
			details: [
